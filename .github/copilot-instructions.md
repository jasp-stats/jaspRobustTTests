...
- **[Fix & Debug Analysis](.github/instructions/fix-debug-analysis.instructions.md)** - Fixing bugs and debugging JASP analyses via code inspection and saveRDS() state capture
